...
<<<<<<< /home/runner/work/IPClaw/IPClaw/.claude/skills/add-voice-transcription/modify/src/channels/whatsapp.test.ts
...
=======
      ...
      expect(opts.onMessage).not.toHaveBeenCalled();
>>>>>>> /home/runner/work/IPClaw/IPClaw/src/channels/whatsapp.test.ts
    });
